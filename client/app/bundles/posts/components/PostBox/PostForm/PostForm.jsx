...
import css from './PostForm.scss';

const emptyPost = { author: '', text: '' };
...
export default class PostForm extends BaseComponent {
  static propTypes = {
  ...
  resetAndFocus() {
    ...
    const post = { author: this.state.post.author, text: '' };
    this.setState({ post });
  ...
  formHorizontal() {
    return (
      <div>
        <hr />
        <Form horizontal className="postForm form-horizontal" onSubmit={this.handleSubmit}>
  ...
  formStacked() {
    return (
      <div>
        <hr />
        <form className="postForm form form-stacked" onSubmit={this.handleSubmit}>
  ...
  formInline() {
    return (
      <div>
        <hr />
        <Form inline className="postForm" onSubmit={this.handleSubmit}>
  ...
  errorWarning() {
    ...
    return (
      <Alert bsStyle="danger" key="postSubmissionError">
        <strong>Your post was not saved!</strong>
        <ul>
          {errorElements}
        </ul>
      </Alert>
